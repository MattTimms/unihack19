...
class Prediction extends Component {
    ...
    render = () => {
        ...
        if (this.state.maxValues[1] == "benign") {
            console.log("benign");
            out = (
                <p style={{paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', align: 'center'}}>
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        <div style={{paddingLeft: '70px', align: 'center'}}>
                            <Button
                        ...
                        <div style={{paddingLeft: '70px', paddingTop: '20px', align: 'center'}}>
                            <Button
                                class="btn btn-primary"
                    ...
                    <div class="btn-group row" role="group" aria-label="Basic example"
                         style={{paddingLeft: '70px', paddingTop: '20px', align: 'center'}}>
                        <button
                            type="button"
                            onClick={() => {
                                this.props.history.push({
